...
Original: https://github.com/cloudreach/aws-lambda-es-cleanup
Modified by: Andres Ivanov
Modification: Changed how index is split to find date, github version was hardcoded to a dash.
"""
import os
import json
import time
